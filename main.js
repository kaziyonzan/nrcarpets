...
var swiper1 = new Swiper('.mySwiper:nth-of-type(1)', {
    // Your swiper options for the first row
});

var swiper2 = new Swiper('.mySwiper:nth-of-type(2)', {
    // Your swiper options for the second row
});

var swiper3 = new Swiper('.mySwiper:nth-of-type(3)', {
    // Your swiper options for the third row
});
